...
export function handleSwap(event: SwapEvent): void {
  ...
  // interval data
  let zaswapDayData = updateZaswapDayData(event);
  ...
  zaswapDayData.volumeETH = zaswapDayData.volumeETH.plus(volumeETH);
  zaswapDayData.volumeUSD = zaswapDayData.volumeUSD.plus(volumeUSD);
  zaswapDayData.feesUSD = zaswapDayData.feesUSD.plus(feesUSD);
  zaswapDayData.protocolFeesUSD = zaswapDayData.protocolFeesUSD.plus(protocolFeeAmounts.usd);
